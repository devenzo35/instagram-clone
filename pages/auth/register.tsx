...
export default function register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-7 px-4 sm:px-6 lg:px-4">
      <div className="max-w-md w-full space-y-8 p-6 bg-white rounded-lg  border-2">
        <div>
          <img
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border-2 text-sm font-medium rounded-md text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
            >
